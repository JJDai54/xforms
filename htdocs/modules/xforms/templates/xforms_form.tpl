...
<{* ================================================== *}>
<div class="itemHead <{$form_color_set}>-itemHead"><p><h1 class="center"><{$form_output.title}></h1></p></div>

<div class="itemInfo <{$form_color_set}>-itemInfo"><p><{$form_intro}></p></div>
...
<table id="xFormInput" name="xFormInput" class="outer bspacing1 tblForm  <{$form_color_set}>-itemBody" width="100%">
...
<div class="itemFoot <{$form_color_set}>-itemFoot">
