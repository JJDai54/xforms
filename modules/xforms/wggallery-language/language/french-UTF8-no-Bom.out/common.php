...
define ('_CO_WGGALLERY_BACK', 'Retour en arriÃ¨re');
define ('_CO_WGGALLERY_ALL', 'Tous');
define ('_CO_WGGALLERY_UPDATE', 'Mettre Ã  jour');
define ('_CO_WGGALLERY_EXEC', 'ExÃ©cuter');
define ('_CO_WGGALLERY_DOWNLOAD', 'tÃ©lÃ©charger');
define ('_CO_WGGALLERY_DOWNLOAD_ALB', 'TÃ©lÃ©charger l\'album');
...
define ('_CO_WGGALLERY_RATING', 'Ã‰valuation');
// Formes
define ('_CO_WGGALLERY_FORM_UPLOAD', 'TÃ©lÃ©charger un fichier');
...
define ('_CO_WGGALLERY_FORM_TOGGLE_SELECT', 'tout sÃ©lectionner / tout dÃ©sÃ©lectionner');
define ('_CO_WGGALLERY_FORM_IMAGEPICKER', 'SÃ©lectionnez une image');
define ('_CO_WGGALLERY_FORM_SUBMIT_SUBMITUPLOAD', 'Soumettre et tÃ©lÃ©charger les images');
...
define ('_CO_WGGALLERY_FORM_OK', 'EnregistrÃ© avec succÃ¨s');
define ('_CO_WGGALLERY_FORM_DELETE_OK', 'SupprimÃ© avec succÃ¨s');
define ('_CO_WGGALLERY_FORM_SURE_DELETE', "ÃŠtes-vous sÃ»r de supprimer: <b> <span style = 'color: Red;'> %s </span> </b>"); // xoops par dÃ©faut confirme
define ('_CO_WGGALLERY_FORM_SURE_RENEW', "ÃŠtes-vous sÃ»r de mettre Ã  jour: <b> <span style = 'color: Red;'> %s </span> </b>");
...
define ('_CO_WGGALLERY_FORM_ERROR_RESETUSAGE1', 'Erreur lors de la rÃ©initialisation de l\'utilisation d\'un filigrane');
define ('_CO_WGGALLERY_FORM_ERROR_RESETUSAGE2', 'Erreur lors de la rÃ©initialisation de l\'utilisation du filigrane dans les albums');
define ('_CO_WGGALLERY_FORM_ERROR_ALBPID', 'Erreur: albums parents introuvables');
define ('_CO_WGGALLERY_FORM_OK_APPROVE', 'Album enregistrÃ© avec succÃ¨s. Vous serez redirigÃ© pour approuver les images');
// Il n\'y a pas
...
define ('_CO_WGGALLERY_FU_SUBMITTED', 'Image vÃ©rifiÃ©e avec succÃ¨s, veuillez tÃ©lÃ©charger');
define ('_CO_WGGALLERY_FU_UPLOAD', 'TÃ©lÃ©charger une image:');
define ('_CO_WGGALLERY_FU_FAILED', 'Erreurs survenues lors du tÃ©lÃ©chargement des images');
define ('_CO_WGGALLERY_FU_SUCCEEDED', 'TÃ©lÃ©versement rÃ©ussi de toutes les images');
// Boutons d\'album
define ('_CO_WGGALLERY_ALBUM_ADD', 'Ajouter un album');
define ('_CO_WGGALLERY_ALBUM_EDIT', 'Modifier l\'album');
// Ã‰lÃ©ments de collections
define ('_CO_WGGALLERY_COLL_TITLE', 'Collections disponibles');
define ('_CO_WGGALLERY_COLL_ALBUMS', 'Afficher les sous-albums');
// Ã‰lÃ©ments de l\'album
...
define ('_CO_WGGALLERY_ALBUMS_DESC', 'wgGallery est un module XOOPS pour prÃ©senter des images dans des albums et des catÃ©gories');
...
define ('_CO_WGGALLERY_ALBUM_USE_UPLOADED', 'Utiliser une image tÃ©lÃ©chargÃ©e comme image de l\'album');
define ('_CO_WGGALLERY_ALBUM_CREATE_GRID', 'CrÃ©er une grille');
define ('_CO_WGGALLERY_ALBUM_CROP_IMAGE', 'Recadrer l\'image');
define ('_CO_WGGALLERY_ALBUM_FORM_UPLOAD_IMAGE', 'TÃ©lÃ©charger une nouvelle image');
define ('_CO_WGGALLERY_ALBUM_STATE', 'Etat');
define ('_CO_WGGALLERY_ALBUM_DELETE_DESC', 'Attention: Toutes les images liÃ©es Ã  cet album seront Ã©galement supprimÃ©es');
define ('_CO_WGGALLERY_ALBUM_SELECT', 'SÃ©lectionner l\'album');
define ('_CO_WGGALLERY_ALBUM_SELECT_DESC', 'Veuillez sÃ©lectionner l\'album pour tÃ©lÃ©charger les images');
define ('_CO_WGGALLERY_ALBUMS_SHOW', 'Afficher tous les albums');
define ('_CO_WGGALLERY_ALBUMS_SORT', 'Tri des albums');
define ('_CO_WGGALLERY_ALBUM_SORT_SHOWHIDE', 'Cliquez pour afficher / masquer les sous-Ã©lÃ©ments');
define ('_CO_WGGALLERY_ALBUM_IMAGE_ERRORNOTFOUND', 'Erreur: image de l\'album introuvable');
define ('_CO_WGGALLERY_ALBUMS_ERRNOTFOUND', 'Erreur: Image non trouvÃ©e (Image-Id %s)');
...
define ('_CO_WGGALLERY_ALBUM_IH_GRID_SRC1', 'SÃ©lectionner l\'image 1');
define ('_CO_WGGALLERY_ALBUM_IH_GRID_SRC2', 'SÃ©lectionner l\'image 2');
define ('_CO_WGGALLERY_ALBUM_IH_GRID_SRC3', 'SÃ©lectionner l\' image 3');
define ('_CO_WGGALLERY_ALBUM_IH_GRID_SRC4', 'SÃ©lectionner l\'image 4');
define ('_CO_WGGALLERY_ALBUM_IH_GRID_SRC5', 'SÃ©lectionner l\'image 5');
define ('_CO_WGGALLERY_ALBUM_IH_GRID_SRC6', 'SÃ©lectionner l\' image 6');
define ('_CO_WGGALLERY_ALBUM_IH_GRID_CREATE', 'CrÃ©er une grille');
define ('_CO_WGGALLERY_ALBUM_IH_CROP_CREATE', 'CrÃ©er une image');
define ('_CO_WGGALLERY_ALBUM_IH_CROP_MOVE', 'DÃ©placer');
define ('_CO_WGGALLERY_ALBUM_IH_CROP_ZOOMIN', 'Zoom avant');
define ('_CO_WGGALLERY_ALBUM_IH_CROP_ZOOMOUT', 'Zomm arriÃ¨re');
define ('_CO_WGGALLERY_ALBUM_IH_CROP_MOVE_LEFT', 'DÃ©placer vers la gauche');
define ('_CO_WGGALLERY_ALBUM_IH_CROP_MOVE_RIGHT', 'DÃ©placer vers la droite');
...
define ('_CO_WGGALLERY_IMAGES_UPLOAD', 'TÃ©lÃ©charger des images');
define ('_CO_WGGALLERY_IMAGE_MANAGE', 'Gestion des images');
define ('_CO_WGGALLERY_IMAGE_MANAGE_DESC', 'Regroupez vos images par glisser-dÃ©poser');
...
define ('_CO_WGGALLERY_IMAGE_RES', 'RÃ©solution');
define ('_CO_WGGALLERY_IMAGE_RESX', 'Resx');
define ('_CO_WGGALLERY_IMAGE_RESY', 'Resy');
define ('_CO_WGGALLERY_IMAGE_DOWNLOADS', 'TÃ©lÃ©chargements');
...
define ('_CO_WGGALLERY_IMAGE_STATE', 'Ã‰tat');
define ('_CO_WGGALLERY_IMAGE_IP', 'Ip');
define ('_CO_WGGALLERY_IMAGE_RESIZE', 'Redimensionner l\'image Ã  la taille suivante:');
...
define ('_CO_WGGALLERY_IMAGE_ROTATE_LEFT', 'Rotation Ã  gauche');
define ('_CO_WGGALLERY_IMAGE_ROTATE_RIGHT', 'Rotation Ã  droite');
define ('_CO_WGGALLERY_IMAGE_ROTATED', 'Image pivotÃ©e avec succÃ¨s');
define ('_CO_WGGALLERY_IMAGE_ROTATE_ERROR', 'Erreur lors de la rotation de l\'image');
define ('_CO_WGGALLERY_IMAGE_ERRORUNLINK', 'Erreur lors de la suppression de l\'image: l\'image a Ã©tÃ© supprimÃ©e dans la base de donnÃ©es, mais une erreur s\'est produite lors de la suppression de l\'image elle-mÃªme');
...
define ('_CO_WGGALLERY_WATERMARK_POSTOPLEFT', 'En haut Ã  gauche');
define ('_CO_WGGALLERY_WATERMARK_POSTOPRIGHT', 'En haut Ã  droite');
...
define ('_CO_WGGALLERY_WATERMARK_POSBOTTOMLEFT', 'En bas Ã  gauche');
define ('_CO_WGGALLERY_WATERMARK_POSBOTTOMRIGHT', 'En bas Ã  droite');
define ('_CO_WGGALLERY_WATERMARK_POSBOTTOMCENTER', 'En bas au centre');
define ('_CO_WGGALLERY_WATERMARK_USAGENONE', 'Actuellement non utilisÃ©');
define ('_CO_WGGALLERY_WATERMARK_USAGEALL', 'Utiliser dans tous les albums');
define ('_CO_WGGALLERY_WATERMARK_USAGESINGLE', 'DÃ©finis sÃ©parÃ©ment dans chaque album');
...
define ('_CO_WGGALLERY_FORM_UPLOAD_IMAGE_WATERMARKS', 'Image dans les images tÃ©lÃ©chargÃ©es');
...
define ('_CO_WGGALLERY_WATERMARK_TARGET_A', 'Ajouter Ã  tous');
define ('_CO_WGGALLERY_WATERMARK_TARGET_M', 'Ajouter au support');
define ('_CO_WGGALLERY_WATERMARK_TARGET_L', 'Ajouter Ã  grand');
// Ã‰lÃ©ments de catÃ©gories
define ('_CO_WGGALLERY_CAT', 'Category');
define ('_CO_WGGALLERY_CATS', 'CatÃ©gories');
define ('_CO_WGGALLERY_CATS_SELECT', 'SÃ©lectionner des catÃ©gories');
// Ã‰lÃ©ments de balises
...
define ('_CO_WGGALLERY_PERMS_GLOBAL_USECOLL_DESC', '<ul> <li> L\'utilisateur est autorisÃ© Ã  combiner plusieurs albums dans une collection d\'albums </li> </ul>');
define ('_CO_WGGALLERY_PERMS_GLOBAL_SUBMITALL', 'Permissions globales pour soumettre / Ã©diter tous les albums');
define ('_CO_WGGALLERY_PERMS_GLOBAL_SUBMITALL_DESC', 'Groupes qui devraient avoir des autorisations pour <ul> <li> crÃ©er des albums </li> <li> modifier tous les albums </li> <li> approuver tous les albums </li> <li> tÃ©lÃ©charger des images Ã  tous les albums </li> <li> approuver toutes les images </li> </ul> ');
define ('_CO_WGGALLERY_PERMS_GLOBAL_SUBMITOWN', 'Permissions globales pour soumettre / Ã©diter vos propres albums sans approbation');
define ('_CO_WGGALLERY_PERMS_GLOBAL_SUBMITOWN_DESC', 'Groupes qui devraient avoir l\'autorisation de <ul> <li> crÃ©er des albums </li> <li> modifier vos propres albums </li> <li> tÃ©lÃ©charger des images dans vos propres albums </li> </ ul > ');
define ('_CO_WGGALLERY_PERMS_GLOBAL_SUBMITAPPR', 'Autorisations globales pour soumettre / Ã©diter ses propres albums uniquement avec approbation');
define ('_CO_WGGALLERY_PERMS_GLOBAL_SUBMITAPPR_DESC', 'Groupes qui devraient avoir l\'autorisation de <ul> <li> crÃ©er des albums </li> <li> modifier vos propres albums </li> <li> tÃ©lÃ©charger des images dans vos propres albums </li> </ ul > ');
...
define ('_CO_WGGALLERY_PERMS_ALB_DLFULLALB', 'Autorisations pour tÃ©lÃ©charger l\'album complet');
define ('_CO_WGGALLERY_PERMS_ALB_DLFULLALB_DESC', 'Groupes qui devraient avoir les autorisations pour tÃ©lÃ©charger l\'album complet Ã  la fois');
define ('_CO_WGGALLERY_PERMS_ALB_DLIMAGE_LARGE', 'Autorisations pour afficher / tÃ©lÃ©charger de grandes images');
define ('_CO_WGGALLERY_PERMS_ALB_DLIMAGE_LARGE_DESC', 'Groupes qui devraient avoir des autorisations pour afficher et tÃ©lÃ©charger de grandes images');
define ('_CO_WGGALLERY_PERMS_ALB_DLIMAGE_MEDIUM', 'Autorisations pour visualiser / tÃ©lÃ©charger des images moyennes');
define ('_CO_WGGALLERY_PERMS_ALB_DLIMAGE_MEDIUM_DESC', 'Groupes qui devraient avoir des autorisations pour visualiser et tÃ©lÃ©charger des images moyennes');
define ('_CO_WGGALLERY_PERMS_NOTSET', 'Aucun jeu d\'autorisations');
define ('_CO_WGGALLERY_PERMS_NODOWNLOAD', 'Vous n\'avez pas la permission de tÃ©lÃ©charger');
// exif
define ('_CO_WGGALLERY_EXIF', 'Fichier original des donnÃ©es Exif');
...
define ('_CO_WGGALLERY_EXIF_CAMERA', 'Marque de la camÃ©ra');
define ('_CO_WGGALLERY_EXIF_MODEL', 'ModÃ¨le');
...
define ('_CO_WGGALLERY_EXIF_LENSMODEL', 'ModÃ¨le d\'objectif');
// ---------------- Divers ----------------
define ('_CO_WGGALLERY_MAINTAINEDBY', 'Maintenu par');
define ('_CO_WGGALLERY_MAINTAINEDBY_DESC', 'Autoriser l\'url du site d\'assistance ou de la communautÃ©');

$moduleDirName = basename (dirname (dirname (__DIR__)));
$moduleDirNameUpper = mb_strtoupper ($moduleDirName);

// Exemples de donnÃ©es
define ('CO_'. $moduleDirNameUpper. '_'. 'ADD_SAMPLEDATA', 'Importer des exemples de donnÃ©es (supprimera TOUTES les donnÃ©es actuelles)');
define ('CO_'. $moduleDirNameUpper. '_'. 'SAMPLEDATA_SUCCESS', 'Date simple uploadÃ© avec succÃ¨s');
...
define ('CO_'. $moduleDirNameUpper. '_'. 'SHOW_SAMPLE_BUTTON_DESC', 'Si oui, le bouton "Ajouter des exemples de donnÃ©es" sera visible par l\'administrateur. Il est Oui par dÃ©faut pour la premiÃ¨re installation.');
define ('CO_'. $moduleDirNameUpper. '_'. 'EXPORT_SCHEMA', 'Export DB Schema vers YAML');
define ('CO_'. $moduleDirNameUpper. '_'. 'EXPORT_SCHEMA_SUCCESS', 'Exporter le schÃ©ma DB vers YAML a Ã©tÃ© un succÃ¨s');
define ('CO_'. $moduleDirNameUpper. '_'. 'EXPORT_SCHEMA_ERROR', 'ERREUR: Ã©chec de lâ€™exportation du schÃ©ma DB vers YAML');

//Menu
define ('CO_'. $moduleDirNameUpper. '_'. 'ADMENU_MIGRATE', 'Migration');
define ('CO_'. $moduleDirNameUpper. '_'. 'FOLDER_YES', 'Le dossier "%s" existe');
define ('CO_'. $moduleDirNameUpper. '_'. 'FOLDER_NO', 'Le dossier "%s" n\'existe pas. CrÃ©ez le dossier spÃ©cifiÃ© avec CHMOD 777.');
define ('CO_'. $moduleDirNameUpper. '_'. 'SHOW_DEV_TOOLS', 'Montrer le bouton des outils de dÃ©veloppement ?');
define ('CO_'. $moduleDirNameUpper. '_'. 'SHOW_DEV_TOOLS_DESC', 'Si oui, l\'onglet "Migrer" et les autres outils de dÃ©veloppement seront visibles par l\'administrateur.');
define ('CO_'. $moduleDirNameUpper. '_'. 'ADMENU_FEEDBACK', 'Retour d\'information');

// VÃ©rification de la derniÃ¨re version
