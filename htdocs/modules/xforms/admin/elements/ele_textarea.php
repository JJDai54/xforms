...
$isEmailsList = !empty($value[4]) ? (int)$value[4] : 0;
...
$emailsListEle  = new \XoopsFormRadioYN(_AM_XFORMS_ELE_ISEMALSLIST, 'ele_value[4]', $isEmailsList);
$emailsListEle->setdescription(_AM_XFORMS_ELE_ISEMALSLIST_DESC);
...
$output->addElement($emailsListEle);