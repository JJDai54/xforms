...
/**
 * xforms - dorms management module for xoops
 *
...
$templateMain = 'admin/xforms_about.tpl';
...
function contribution(){
    ...
    $html[] = "<div>" . _AM_XFORMS_WHY_DONATE . "</div><center>";
...
$module_dir = basename(dirname(dirname(__FILE__)));
    ...
    $html[] = _AM_XFORMS_BY . " ".  $helper->getModule()->getInfo('author');
    $html[] = "</div>";
...
/* ------------------------- Module -----------------------------*/
$box['paypal']['legend'] = _AM_XFORMS_CONTRIBUTION;
