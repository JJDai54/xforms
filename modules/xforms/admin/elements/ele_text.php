...
*/
//JJDai - il faudrait renommer ces variables car elles concernent aussi le nom de l'utilisatuer
$contEmail = (isset($value[3])  ? $value[3] : 0);
$emailIndicator = new \XoopsFormRadio(_AM_XFORMS_ELE_CONTAINS, 'ele_value[3]', $contEmail);
$emailIndicator->setDescription(_AM_XFORMS_ELE_CONTAINS_DESC);
$emailIndicator->addOptionArray(array(0 => _AM_XFORMS_ELE_USAGE_IS_NOTHING,
                                      1 => _AM_XFORMS_ELE_USAGE_IS_EMAIL,
                                      2 => _AM_XFORMS_ELE_USAGE_IS_USER_NAME,
                                      3 => _AM_XFORMS_ELE_USAGE_IS_OBJET)
                                );
