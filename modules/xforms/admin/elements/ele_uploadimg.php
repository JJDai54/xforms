...
// $ext         = empty($eleId[1]) ? 'jpg|jpeg|gif|png|tif|tiff' : $value[1];
// $mime        = empty($eleId[2]) ? 'image/jpeg|image/pjpeg|image/png|image/x-png|image/gif|image/tiff' : $value[2];
$ext         = !empty($value[1]) ? (string)$value[1] : 'jpg|jpeg|gif|png|tif|tiff';
$mime        = !empty($value[2]) ? (string)$value[2] : 'image/jpeg|image/pjpeg|image/png|image/x-png|image/gif|image/tiff';
...
$mimeExtIn   = empty($value[1]) ? $mimeExt : $ext;
$mimeTypesIn = empty($value[2]) ? $mimeTypes : $mime;
