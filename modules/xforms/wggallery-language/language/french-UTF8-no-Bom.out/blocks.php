...
define ('_MB_WGGALLERY_BLOCKTYPE_DEFAULT', 'Par dÃ©faut (triÃ© par date dÃ©croissante)');
define ('_MB_WGGALLERY_BLOCKTYPE_RECENT', 'Articles rÃ©cents');
define ('_MB_WGGALLERY_BLOCKTYPE_RANDOM', 'Articles alÃ©atoires');
...
define ('_MB_WGGALLERY_SHOW', 'Action aprÃ¨s avoir cliquÃ© sur l\'album');
define ('_MB_WGGALLERY_SHOW_GALLERY', 'Afficher la galerie (si un type de galerie est sÃ©lectionnÃ©)');
define ('_MB_WGGALLERY_SHOW_INDEX', 'Afficher la page d\'index');
define ('_MB_WGGALLERY_NUMB_ALBUMS', 'Nombre d\'albums Ã  afficher sur chaque ligne');
define ('_MB_WGGALLERY_ALBUMS_DISPLAYLIST', 'Combien d\'albums Ã  charger pour la liste d\'affichage');
define ('_MB_WGGALLERY_ALBUMS_TO_DISPLAY', 'Albums Ã  afficher');
define ('_MB_WGGALLERY_ALL_ALBUMS', "Tous les albums avec l'Ã©tat 'en ligne'");
...
define ('_MB_WGGALLERY_ALBUMTYPES_OTHER', "IndÃ©pendant du type d'album principal, utilisez le type d'album '%s'");
define ('_MB_WGGALLERY_NUMB_IMAGES', 'Nombre d\'images Ã  afficher dans chaque ligne');
...
define('_MB_WGGALLERY_XBOOTSTRAP_NEW_ALBUM', 'CrÃ©er un nouvel album');
